"""
Starter fabfile for deploying the Map project.
...
# CHANGEME
env.hosts = ['user@Map.example.com']
env.code_dir = '/srv/www/Map'
env.project_dir = '/srv/www/Map/Map'
env.static_root = '/srv/www/Map/static/'
env.virtualenv = '/srv/www/Map/.virtualenv'
env.code_repo = 'git@github.com:user/Map.git'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/Map/wsgi.py" % env.code_dir)
